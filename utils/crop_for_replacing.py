...
if __name__ == '__main__':
    ...
    image = cv2.imread('/data1/yutao/projects/IAM/test_file/example/fill-anything/sample5.jpeg')
    mask = cv2.imread('/data1/yutao/projects/IAM/test_file/example/fill-anything/sample5/mask.png', cv2.IMREAD_GRAYSCALE)
    print(image.shape)
    print(mask.shape)
